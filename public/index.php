...
// Update author by ID
$app->put('/authors/{id}', function (Request $request, Response $response, array $args) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
...
// Get all authors
$app->get('/authors', function (Request $request, Response $response) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
...
// Update book by ID
$app->put('/books/{id}', function (Request $request, Response $response, array $args) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
...
// Get all books
$app->get('/books', function (Request $request, Response $response) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
...
// Delete book by ID
$app->delete('/books/{id}', function (Request $request, Response $response, array $args) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
...
// Delete author by ID
$app->delete('/authors/{id}', function (Request $request, Response $response, array $args) use ($key) {
    removeExpiredTokens();  // Clean up expired tokens
    $userid = $request->getAttribute('userid');
